...
class IntegratedSummarizerApp:
    ...
    def run_summarization(self):
        ...
        try:
            ...
            self.summaries['Frequency'] = self.frequency_based_summary(num_sentences)
            self.summaries['Position'] = self.position_based_summary(num_sentences)
            self.summaries['TF-IDF'] = self.tfidf_based_summary(num_sentences)
            self.summaries['TextRank'] = self.textrank_summary(num_sentences)
            self.summaries['Clustering'] = self.clustering_based_summary(num_sentences)
